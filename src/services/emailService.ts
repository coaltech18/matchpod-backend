...
function logEmailAttempt(
  type: 'send' | 'success' | 'failure',
  payload: EmailPayload,
  context: { userId?: string; error?: string }
): void {
 ...
 */
function generateWelcomeEmailHtml(userName: string, appUrl: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
 ...
 */
function generateWelcomeEmailText(userName: string, appUrl: string): string {
  return `
Welcome to MatchPod! 🎉
