...
exports.socketRateLimiters = exports.SocketRateLimiter = exports.SOCKET_RATE_LIMITS = exports.swipeRateLimit = exports.chatRateLimit = exports.registerRateLimit = exports.refreshRateLimit = exports.loginRateLimit = exports.otpRateLimit = exports.authRateLimit = exports.apiRateLimit = void 0;
...
class RateLimiter {
    ...
    async consume(identifier) {
        ...
        const count = results ? results[2] || 0 : 0;
 ...
 */
function createRateLimiter(type, getIdentifier) {
 ...
 */
exports.refreshRateLimit = createRateLimiter('refresh');
/**
 * Registration rate limiting - 3 accounts/hour per IP
 * Phase 4: NEW - Prevents account creation abuse
 */
exports.registerRateLimit = createRateLimiter('register');
/** Chat message rate limiting - 50 msg/min */
exports.chatRateLimit = createRateLimiter('chat');
/** Swipe rate limiting - 100 swipes/min */
exports.swipeRateLimit = createRateLimiter('swipe');
// =============================================================================
...
class SocketRateLimiter {
    constructor(limit, windowMs = exports.SOCKET_RATE_LIMITS.WINDOW_MS) {
        this.counts = new Map();
        this.limit = limit;
...
exports.socketRateLimiters = {
    messages: new SocketRateLimiter(exports.SOCKET_RATE_LIMITS.MESSAGES_PER_MINUTE),
    typing: new SocketRateLimiter(exports.SOCKET_RATE_LIMITS.TYPING_PER_MINUTE),
    roomJoins: new SocketRateLimiter(exports.SOCKET_RATE_LIMITS.ROOM_JOINS_PER_MINUTE),
};
// Cleanup interval for socket rate limiters (every 5 minutes)
setInterval(() => {
    exports.socketRateLimiters.messages.cleanup();
    exports.socketRateLimiters.typing.cleanup();
    exports.socketRateLimiters.roomJoins.cleanup();
}, 5 * 60 * 1000);
