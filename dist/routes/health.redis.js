...
exports.redisHealthRouter = void 0;
const express_1 = require("express");
const client_1 = require("../redis/client");
const router = (0, express_1.Router)();
exports.redisHealthRouter = router;
/**
...
router.get('/redis', async (req, res) => {
    ...
    try {
        ...
        const isReady = (0, client_1.isRedisReady)();
        if (!isReady) {
        ...
        const pingResult = await (0, client_1.pingRedis)(250);
        ...
        console.warn(`Redis health check failed after ${responseTime}ms:`, error instanceof Error ? error.message : 'Unknown error');
        return res.status(503).json({
            status: 'down',
            reason: 'error',
            responseTime,
