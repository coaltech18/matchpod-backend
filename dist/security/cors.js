...
exports.corsSecurityHeaders = exports.devCorsOptions = exports.strictCorsOptions = exports.corsOptions = void 0;
exports.getCorsOptions = getCorsOptions;
exports.corsForRoute = corsForRoute;
exports.validateOriginForRoute = validateOriginForRoute;
...
function validateOriginForRoute(origin, route) {
    const allowedOrigins = getAllowedOrigins();
    // Check if origin is allowed
    const isAllowed = allowedOrigins.some(allowedOrigin => {
        if (allowedOrigin.includes('*')) {
...
exports.default = {
    ...
    corsSecurityHeaders: exports.corsSecurityHeaders,
};
